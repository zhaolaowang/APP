	...
	<div>
		<div class="login_wrapper">
			<div class="animate form login_form">
				...
				<form action="${pageContext.request.contextPath }/dev/devloginAction" method="post">
					<h1>APP开发者管理平台</h1>
					<div class="">${error}</div>
					<div>
					...
					<div>
						<input type="submit" class="btn btn-success" value="登陆"> <input
							...
							onclick="javascript:window.location.href='${pageContext.request.contextPath }/index.jsp'" > <input
							type="reset" class="btn btn-default" value="重填"> </div>
