...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>
					新增APP版本信息 <i class="fa fa-user"></i><small>${devUserSession.devName}</small>
				</h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_title">
								...
								<tbody>
									<c:forEach var="appVersion" items="${appVersionList }"
										...
										<tr role="row" class="odd">
											...
											<td><a href="${appVersion.appVersion.downloadLink }">${appVersion.appVersion.apkFileName
													}</a></td>
											<td><fmt:formatDate
													value="${appVersion.appVersion.modifyDate }"
													pattern="yyyy-MM-dd" />
											</td>
										</tr>
									</c:forEach>
