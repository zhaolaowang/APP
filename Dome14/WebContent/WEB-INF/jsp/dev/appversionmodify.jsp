			...
			<div class="x_content1">
					...
					<div class="row">
						<div class="col-sm-12">
							<table id="datatable-responsive"
								...
								<tbody>
									<c:forEach var="appVersions" items="${appVersionList }"
										varStatus="status">
										<tr role="row" class="odd">
											<td tabindex="0" class="sorting_1">${appVersions.apkName}</td>
											<td>${appVersions.versionNo }</td>
											<td>${appVersions.appVersion.versionSize }</td>
											<td>${appVersions.appVersion.publishStatusName }</td>
											<td><a href="${appVersions.appVersion.downloadLink }">${appVersions.appVersion.apkFileName
													}</a></td>
											<td><fmt:formatDate
													value="${appVersions.appVersion.modifyDate }"
													pattern="yyyy-MM-dd" />
											</td>
										</tr>
									</c:forEach>
				...
				<div class="x_content" style="display: block;">
					...
					<form class="form-horizontal form-label-left"
						action="appVersionUpdateSave" method="post"
