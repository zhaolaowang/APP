...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>
					APP 信息查看和审核 <i class="fa fa-user"></i><small>${userSession.userCode
						} - 您可以通过搜索或者其他的筛选项对APP的信息查看和审核操作。^_^</small>
				</h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_content">
				<form method="post"
					action="${pageContext.request.contextPath}/sys/backend/loadAppInfoList">
					...
					<ul>
						...
						<li>
							<div class="form-group">
								<label class=".control-label col-md-3 col-sm-3 col-xs-12">${dataDictionary.valueId}所属平台${queryFlatformId
									}</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
					...
					<div class="row">
						<div class="col-sm-12">
							<table id="datatable-responsive"
								...
								<tbody>
									<c:forEach var="appInfo" items="${pages.appInfoList }"
										varStatus="status">
										<tr role="row" class="odd">
											...
											<td>
												<button appinfoid="${appInfo.id}" status="${appInfo.status}"
													versionid="${appInfo.versionId}" statusName ="${appInfo.statusName}" type="button"
													class="checkApp">审核</button>
											</td>
										</tr> 
									</c:forEach>
								</tbody>
