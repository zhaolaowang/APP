			...
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="${pageContext.request.contextPath }/sys/backend/main"
							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-home"></i> APP管理 <span
									...
									<ul class="nav child_menu">
										<li><a
											href="${pageContext.request.contextPath}/sys/backend/loadAppInfoList">APP审核</a>
										</li>
										<li><a href="javascript:;">广告推广</a>
										</li>
									</ul></li>
								<li><a><i class="fa fa-edit"></i> 用户管理 <span
										class="fa fa-chevron-down"></span> </a>
									<ul class="nav child_menu">
										<li><a href="javascript:;">后台用户管理</a>
										</li>
										<li><a href="javascript:;">开发者资质审核</a>
										</li>
									</ul></li>
								<li><a><i class="fa fa-bug"></i> 基础数据维护 <span
									...
									<ul class="nav child_menu">
										<li><a
											href="${pageContext.request.contextPath }/sys/dic/showDictionary.html">数据字典</a>
										</li>
										<li><a
											href="${pageContext.request.contextPath }/sys/contory/showCategory.html">APP分类管理</a>
										</li>
									</ul></li>
							</ul>
						</div>
								...
								<ul id="menu1" class="dropdown-menu list-unstyled msg_list"
									...
									<li><a> <span class="image"><img
												...
												alt="Profile Image" /> </span> <span> <span>John
													Smith</span> <span class="time">3 mins ago</span> </span> <span
											class="message"> Film festivals used to be do-or-die
												moments for movie makers. They were where... </span> </a></li>
									<li><a> <span class="image"><img
												src="${pageContext.request.contextPath }/statics/images/img.jpg"
												alt="Profile Image" /> </span> <span> <span>John
													Smith</span> <span class="time">3 mins ago</span> </span> <span
