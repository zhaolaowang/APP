...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>
					查看并审核APP信息 <i class="fa fa-user"></i>${backendSession.userName}</small>
				</h2>
				<div class="clearfix"></div>
			</div>
			<div class="x_title">
			...
			<div class="x_content1">
				<form class="form-horizontal form-label-left" action="checkAppInfoSave"
					method="post">
					...
					<div class="item form-group">
						<label class="control-label col-md-3 col-sm-3 col-xs-12"
							for="select">所属分类 <span class="required">*</span>
						</label>
						<div class="col-md-6 col-sm-6 col-xs-12">
							<input type="text" class="form-control col-md-7 col-xs-12"
								value="${appInfo.cateGoryLevelName1} --> ${appInfo.cateGoryLevelName2} --> ${appInfo.cateGoryLevelName3}"
								readonly="readonly">
						</div>
					</div>
					<div class="item form-group">
              ...
              ${appInfo.appInfo}</textarea>
					...
					<div class="form-group">
						<div class="col-md-6 col-md-offset-3">
							<button id="status" type="submit" name="status" value="2"
								class="btn btn-success">审核通过</button>
							<button id="status" type="submit" name="status" value="3"
              ...
              ${appVersion.versionInfo }</textarea>
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							<c:choose>
								<c:when
									test="${appVersion.downloadLink == null || appVersion.downloadLink == ''}">   
			    	暂无
			  </c:when>
								<c:otherwise>
									<p>
										${appVersion.apkFileName}&nbsp;&nbsp; <a
											href="${appVersion.downloadLink}">下载</a>
									</p>
								</c:otherwise>
							</c:choose>
						</div>
	...
	<script
		src="${pageContext.request.contextPath }/statics/localjs/appcheck.js"></script>