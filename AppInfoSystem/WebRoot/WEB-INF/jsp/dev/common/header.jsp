							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-home"></i> APP账户管理 <span
									...
									<ul class="nav child_menu">
										<li><a
											href="${pageContext.request.contextPath }/manager/backend/app/list">APP审核</a>
										</li>
								...
								<li><a><i class="fa fa-edit"></i> APP应用管理 <span
									...
									<ul class="nav child_menu">
										<li><a
											href="${pageContext.request.contextPath }/sys/dev/loadAppInfoList">APP维护</a>
										</li>
									</ul></li>
							</ul>
						</div>
