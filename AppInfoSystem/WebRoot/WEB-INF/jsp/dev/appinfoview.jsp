      ...
      <div class="x_content1">
        <form class="form-horizontal form-label-left" >
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" class="form-control col-md-7 col-xs-12" 
              	value="${appInfo.cateGoryLevelName1} --> ${appInfo.cateGoryLevelName2} --> ${appInfo.cateGoryLevelName3}" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
						...
						<tbody>
							<c:forEach var="appVersion" items="${appVersionList }" varStatus="status">
								<tr role="row" class="odd">
									<td tabindex="0" class="sorting_1">${appVersion.apkName}</td>
									<td>${appVersion.versionNo }</td>
									<td>${appVersion.appVersion.versionSize }</td>
									<td>${appVersion.appVersion.publishStatusName }</td>
									<td>
									<a href="${appVersion.appVersion.downloadLink }">${appVersion.appVersion.apkFileName }</a>
									</td>
									<td><fmt:formatDate value="${appVersion.appVersion.modifyDate }" pattern="yyyy-MM-dd"/></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
